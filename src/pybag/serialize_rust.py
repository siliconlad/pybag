"""Rust-accelerated message serializer."""
...
class MessageSerializer:
    """Serialize dataclass messages using Rust-accelerated CDR encoder."""
...
class MessageSerializerFactory:
    """Factory for creating Rust-accelerated message serializers."""
