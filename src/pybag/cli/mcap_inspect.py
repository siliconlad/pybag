"""MCAP inspect CLI command for examining record contents."""
...
def add_parser(subparsers) -> None:
    ...
    inspect_parser = subparsers.add_parser(
        "inspect",
        help="Inspect MCAP record contents.",
        description=dedent("""
            Inspect the contents of MCAP records. Supports examining schemas,
            channels, metadata, and attachments.
            ...
            Use subcommands to inspect specific record types:
              ...
              pybag inspect metadata <file>     - List all metadata
              pybag inspect attachments <file>  - List all attachments
    ...
    schema_parser = inspect_subparsers.add_parser(
        "schemas",
        help="Inspect schemas in an MCAP file.",
        description="List or inspect schema records.",
    )
    schema_parser.add_argument("input", help="Path to MCAP file (*.mcap)")
    ...
    channel_parser = inspect_subparsers.add_parser(
        "channels",
        help="Inspect channels in an MCAP file.",
        description="List or inspect channel records. Channels represent topics/subscriptions.",
    )
    channel_parser.add_argument("input", help="Path to MCAP file (*.mcap)")
    ...
    metadata_parser = inspect_subparsers.add_parser(
        "metadata",
        help="Inspect metadata in an MCAP file.",
        description="List or inspect metadata records. Metadata stores custom key-value pairs.",
    )
    metadata_parser.add_argument("input", help="Path to MCAP file (*.mcap)")
    ...
    attachment_parser = inspect_subparsers.add_parser(
        "attachments",
        help="Inspect attachments in an MCAP file.",
        description="List or inspect attachment records. Attachments are arbitrary file data.",
    )
    attachment_parser.add_argument("input", help="Path to MCAP file (*.mcap)")
